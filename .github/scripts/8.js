module.exports = async function ({ github, context, core, env }) {
    ...
    const dataGenIssue = await github.rest.issues.create({
        ...
        body: [
            ...
            '',
            'You have to do one of the two options below.',
            '',
            ...
            '1. Person A creates a new branch [Branches → new branch].', 
            '2. Person A makes changes on their branch.',
            `3. Person A creates a pull request after uploading data. [Pull requests → New pull request.](https://github.com/${owner}/${repo}/pulls). Select as base repository person B's repo.`,
            '4. Person B reviews and merges the pull request.',
            '',
            '### Step 3: Both Upload Your Data Files',
            '',
            'You have to do one of the three options below.',
            '',
            '**Each person uploads their own generated data to their `data` folder.**',
            '',
